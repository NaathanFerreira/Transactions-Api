...
function checkSessionIdExists(req, reply) {
...
function transactionsRoutes(app) {
  return __async(this, null, function* () {
    app.addHook("preHandler", (request, reply) => __async(this, null, function* () {
      console.log(`[${request.method}] ${request.url}`);
    }));
    app.get("/", { preHandler: [checkSessionIdExists] }, (req, reply) => __async(this, null, function* () {
    ...
    app.post("/", (req, reply) => __async(this, null, function* () {
